"""Document upload, parsing, and preprocessing pipeline"""
...
app = FastAPI(title="document-ingestion", description="Document upload, parsing, and preprocessing pipeline", version="1.0.0", lifespan=lifespan)

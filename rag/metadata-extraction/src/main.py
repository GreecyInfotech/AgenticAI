"""Document metadata and entity extraction"""
...
SERVICE_NAME = "metadata-extraction"
SERVICE_PORT = 8204
...
app = FastAPI(title="metadata-extraction", description="Document metadata and entity extraction", version="1.0.0", lifespan=lifespan)
